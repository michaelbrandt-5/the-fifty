...
const CITY_LOCATIONS = LOCATIONS["chicago"] || {};
...
export default function ChicagoCityPage() {
  ...
  return (
    <>
      <PageMeta page="city" citySlug="chicago" entries={ENTRIES} />
    <div style={{ backgroundColor: "#FAF7F2", minHeight: "100vh", fontFamily: "system-ui, -apple-system, sans-serif" }}>
      ...
      <CityMap entries={ENTRIES} locations={CITY_LOCATIONS} cityName="Chicago" />
      <Footer />
    </div>
    </>
  );
