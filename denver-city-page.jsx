...
const ENTRIES = [
  ...
  },
  {
    ...
    category: "Drink",
    neighborhood: "LoDo",
    description: "A rooftop bar atop The Rally Hotel with sweeping views of Coors Field and the downtown skyline. The cocktail program is polished and seasonal, the space is open-air and elegant, and on a summer evening with the mountains catching the last light, there's no better perch in the city. It's a scene, but a good one.",
    signature: "A warm evening, a seat facing west, and whatever seasonal spritz they're pouring. That's the whole plan.",
    action: "Get Directions",
    actionType: "directions",
    image: null,
  },
  ...
  },
  {
    ...
    category: "Coffee",
    neighborhood: "Five Points",
    description: "A slick, minimal coffee bar in Five Points that doubles as a creative studio and community hub. The espresso program sources from top roasters nationwide, the space is beautifully designed with local art on the walls, and there's a deliberate energy that reflects the neighborhood's creative renaissance. Coffee with intention.",
    signature: "The oat milk latte with the house-made vanilla. Sit at the bar and watch the neighborhood walk by.",
    action: "Get Directions",
    actionType: "directions",
    image: null,
  },
  ...
  },
  {
    ...
    category: "Shop",
    neighborhood: "LoDo",
    description: "A Western wear shop in Larimer Square that splits the difference between authentic and ironic. Vintage cowboy boots, turquoise jewelry, custom belt buckles, and a curated selection of Western shirts that you'll actually wear back home. It's not a costume shop — it's a place that understands Western style as living fashion, not museum piece.",
    signature: "The vintage boot wall. Every pair is one-of-a-kind, and the staff can size you by sight.",
    action: "Get Directions",
    actionType: "directions",
    image: null,
  },
      ...
      <div style={{ width: 375, margin: "0 auto", borderRadius: 40, border: "8px solid #1a1a1a", overflow: "hidden", boxShadow: "0 20px 60px rgba(0,0,0,0.15)", backgroundColor: "#FAF7F2" }}>
        ...
        <div style={{ padding: "0 20px 20px", opacity: 0.4 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12, paddingTop: 16, borderTop: "1px solid rgba(0,0,0,0.06)" }}>
            ...
            <div>
              <span style={{ fontFamily: "'Georgia', serif", fontSize: 16, color: "#1a1a1a" }}>Hotel Clio</span>
              <span style={{ display: "block", fontSize: 11, color: "#999", marginTop: 2 }}>Stay · Highland</span>
            </div>
          </div>
        </div>
      </div>
