...
const CITY_LOCATIONS = LOCATIONS["new-york"] || {};
...
export default function NewYorkCityPage() {
  ...
  return (
    <>
      <PageMeta page="city" citySlug="new-york" entries={ENTRIES} />
    <div style={{ backgroundColor: "#FAF7F2", minHeight: "100vh", fontFamily: "system-ui, -apple-system, sans-serif" }}>
      ...
      <CityMap entries={ENTRIES} locations={CITY_LOCATIONS} cityName="New York" />
      <Footer />
    </div>
    </>
  );
