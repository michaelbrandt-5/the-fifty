...
const ENTRIES = [
  ...
  },
  {
    ...
    category: "Drink",
    neighborhood: "Alberta Arts District",
    description: "A tiny, Asia-influenced cocktail bar on Alberta from husband-and-wife team Kyle Linden Webster and Naomi Pomeroy. The drinks are built on a foundation of Southeast Asian flavors — lemongrass, makrut lime, Thai chile — and the snack menu reads like the best bar food you've ever had. The room seats maybe thirty people, and at capacity it feels like the best party you've ever been invited to.",
    signature: "The Siam Sunray — a whiskey drink with coconut and lemongrass — is the sleeper. Pair it with the pork floss bao.",
    action: "Get Directions",
    actionType: "directions",
    image: null,
  },
...
const MobilePreview = () => {
  const entry = ENTRIES[4]; // Le Pigeon
  const catColor = getCategoryColor(entry.category);
  return (
      ...
      <div style={{ width: 375, margin: "0 auto", borderRadius: 40, border: "8px solid #1a1a1a", overflow: "hidden", boxShadow: "0 20px 60px rgba(0,0,0,0.15)", backgroundColor: "#FAF7F2" }}>
        ...
        <div style={{ padding: "0 20px 20px", opacity: 0.4 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12, paddingTop: 16, borderTop: "1px solid rgba(0,0,0,0.06)" }}>
            <span style={{ fontFamily: "'Georgia', serif", fontSize: 28, color: "rgba(0,0,0,0.12)" }}>06</span>
            <div>
              <span style={{ fontFamily: "'Georgia', serif", fontSize: 16, color: "#1a1a1a" }}>Powell's City of Books</span>
              <span style={{ display: "block", fontSize: 11, color: "#999", marginTop: 2 }}>Shop · Pearl District</span>
            </div>
          </div>
        </div>
      </div>
