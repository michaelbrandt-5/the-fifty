...
const ENTRIES = [
  ...
  },
  {
    ...
    category: "Eat",
    neighborhood: "Hawthorne",
    description: "Katy Millard's small, intentional restaurant on SE Belmont — a James Beard-recognized kitchen working with seasonal Oregon produce and the kind of refined-not-fussy technique that defines the best of Portland dining. The chocolate chip cookie alone has cult status. The savory menu earns the room.",
    signature: "Reserve the chef's counter if you can. Order the seasonal tasting. Buy a chocolate chip cookie to-go on the way out — it's the takeaway move.",
    action: "Reserve",
    actionType: "reserve",
    image: null,
  },
