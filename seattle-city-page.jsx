...
export const ENTRIES = [
  ...
  },
  {
    ...
    category: "Coffee",
    neighborhood: "Capitol Hill",
    description: "The Capitol Hill espresso bar that taught Seattle what serious espresso was supposed to taste like. David Schomer opened the original cart in 1988 and the obsessive technique has only sharpened — the in-house roast is balanced and intentional, the latte art was practically invented here, and the staff treats every shot like it matters. Order at the counter and stand to drink. Do not, under any circumstances, ask for a flavored syrup.",
    signature: "A doppio macchiato. Drink it where you stand. Schomer's book on espresso is sold at the counter — buy that too.",
    action: "Get Directions",
    actionType: "directions",
    image: null,
  },
  ...
  },
  {
    ...
    category: "Eat",
    neighborhood: "Capitol Hill",
    description: "The restaurant that taught Seattle what pasta could be. Since 2008, this lace-curtained dining room on 14th Avenue has channeled the Piedmont countryside with a devotion that borders on scholarly, and under chef Stuart Lane it has never dipped. The tajarin — impossibly fine hand-cut egg pasta, rich with yolk, sauced with butter and sage or a slow-simmered ragù — is one of the city's essential dishes. Around it orbit pristine antipasti and a nebbiolo list deep enough to get happily lost in.",
    signature: "Order the tajarin twice — once with butter and sage, once with ragù — and settle the question at the table. The counter seats facing the pasta station are the best in the house.",
    action: "Reserve",
    actionType: "reserve",
    image: null,
  },
  ...
  },
  {
    ...
    signature: "Sit at the counter facing the open kitchen. Order the dry-aged kalbi and the seafood pancake — those two dishes alone are worth the visit.",
    action: "Reserve",
    actionType: "reserve",
    image: null,
  },
  ...
  {
    id: 35,
    name: "Bizzarro Italian Cafe",
    category: "Eat",
    neighborhood: "Wallingford",
    description: "The Wallingford Italian restaurant your friend who's lived in Seattle for twenty years has been telling you about. Tin ceiling, mismatched chandeliers, the kind of decor that looks unironic because it actually is. The pasta is hand-rolled, the meatballs are the size of fists, and the chicken parmesan is exactly as good as you want it to be. Forty years in and still essential.",
    signature: "The cioppino is the one to order. Bring a friend who likes red sauce — there's plenty to share.",
    action: "Reserve",
    actionType: "reserve",
    image: null,
  },
...
export default function SeattleCityPage() {
  ...
  return (
    <>
      <PageMeta page="city" citySlug="seattle" entries={ENTRIES} />
